...
#####################################
# Set up Data Store to hold  counts
#####################################
...
def process_message(message: str) -> None:
    ...
    try:
        ...
        if isinstance(message_dict, dict):
            # Extract 'author' and 'genre' fields
            author = message_dict.get("author", "unknown")
            genre = message_dict.get("genre", "unknown")

            logger.info(f"Message received from author: {author}, Genre: {genre}")
            ...
            logger.info(f"Updated genre counts: {dict(genre_counts)}")
